            ...
            foreach (Project project in projects)
            {
                if (project.UniqueName.EndsWith(".csproj"))
                {
                    ...
                    foreach (var file in newfiles)
                    {
                        ...
                        if (fileList.Count > 0)
                        {
                            if (fileList.All(n => file.IndexOf(n, StringComparison.Ordinal) == -1))
                                continue;
                        }
                        ...
                        if (expList.Count > 0)
                        {
                            if (expList.Any(n => file.IndexOf(n, StringComparison.Ordinal) > -1))
                                continue;
                        }
                        ...
                        if (dirList.Count > 0)
                        {
                            ...
                            {
                                if (dirList.Any(n => path.IndexOf(n, StringComparison.Ordinal) > -1))
                                    continue;
                            }
                        }
